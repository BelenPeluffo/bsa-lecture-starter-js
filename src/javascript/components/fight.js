...
export async function fight(firstFighter, secondFighter) {
    ...
    const keyDownListener = event => {
        ...
        let damage = 0;
        if (!isDefender && (isRegularControl || PlayerOneCriticalHitCombination || PlayerTwoCriticalHitCombination)) {
            damage = getDamage.apply(this, isPlayerOne ? [firstFighter, secondFighter] : [secondFighter, firstFighter]);
